...
try {
  ...
  await page.locator(
    "#usernameField, input[type='email'], input[name='email'], input[placeholder*='Email' i]"
  ).first().fill(loginEmail);

  await page.locator(
    "#passwordField, input[type='password'], input[name='password'], input[placeholder*='Password' i]"
  ).first().fill(loginPassword);
